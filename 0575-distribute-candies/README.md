...
<pre style="position: relative;"><strong>Input:</strong> candyType = [1,1,2,2,3,3]
...
<pre style="position: relative;"><strong>Input:</strong> candyType = [1,1,2,3]
...
<pre style="position: relative;"><strong>Input:</strong> candyType = [6,6,6,6]
